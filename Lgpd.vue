    ...
    <div>
        <div class="lgpd_wd_box" v-if="box">
            <div v-if="config_cookies" class="lgpd_wd_content">
                <div class="lgpd_wd_title">Controle sua privacidade</div>
                <div class="lgpd_wd_text">Utilizamos cookies com objetivo de prover a melhor experiência no uso de nossos serviços. Ao clicar em “Aceitar”, concorda com a utilização de TODOS os cookies.</div>
            ...
            <div v-if="cookies_options" class="lgpd_wd_content">
                ...
                <div class="lgpd_wd_display-flex lgpd_wd_flex-row lgpd_wd_my-20">
                    <div class="lgpd_wd_flex-column">
                        <div class="lgpd_wd_infos">
                            <div class="lgpd_wd_config_title">Cookies essenciais e funcionais</div>
                            <div class="lgpd_wd_config_text">{{essential_text}}</div>
                        </div>
                    </div>
                ...
                <div class="lgpd_wd_display-flex lgpd_wd_flex-row lgpd_wd_my-20">
                    <div class="lgpd_wd_flex-column">
                        <div class="lgpd_wd_infos">
                            <div class="lgpd_wd_config_title">Cookies de desempenho e analíticos</div>
                            <div class="lgpd_wd_config_text">{{analytics_text}}</div>
                        </div>
                    </div>
                    <div class="lgpd_wd_switch">
                        <div>
                ...
                <div class="lgpd_wd_display-flex lgpd_wd_flex-row lgpd_wd_my-20">
                    <div class="lgpd_wd_infos">
                        <div class="lgpd_wd_config_title">Cookies de marketing</div>
                        <div class="lgpd_wd_config_text">{{marketing_text}}</div>
                    </div>
                    <div class="lgpd_wd_switch">
                        <div>
                            <div class="lgpd_wd_onoffswitch">
                ...
                <div class="lgpd_wd_flex-row">
                    <div class="lgpd_wd_links">
                        <div class="lgpd_wd_flex-row lgpd_wd_align-items-center" v-if="privacy_policy_link || cookies_policy_link" >
                            <div class="lgpd_wd_links" v-if="privacy_policy_link">
                                <a :href="privacy_policy_link">Política de privacidade</a>
                            </div>
                            <div class="lgpd_wd_links " v-if="cookies_policy_link">
